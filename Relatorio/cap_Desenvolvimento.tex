...
\subsection{Filtro de imagem média e seleção de imagens propícias} \label{subsec:filtro_media}
...
Foram criados os mesmos vetores $somaHor$ e o $derivadaHor$ ambos do tipo $vetorHor$. Como citado em \ref{subsec:filtro_media} os elementos de $somaHor$ foram calculados a cada pixel recebido, mas os valores de $derivadaHor$ apenas foram calculados ao final da leitura de cada linha.
