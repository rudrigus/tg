...
\def\figuraresult#1#2#3{%
  \foreach \index in {#2, ..., #3} {%
    \subfigure[\index]{
    	\centering
    	\includegraphics[width=.18\textwidth]{./Figuras/#1\index.jpg}}
  }}
...
\titulolinhai{MONITORAÇÃO NO PROCESSO DE SOLDAGEM GMAW}
\titulolinhaii{POR MEIO DE VISÃO COMPUTACIONAL}
\titulolinhaiii{COM PROCESSAMENTO VIA FPGA}
\titulolinhaiv{}
...
\autori{Rodrigo Ferreira Fernandes}
...
\membrodabancai{Prof. Guilherme Caribé, ENM/UnB}
\membrodabancaifuncao{Orientador}
\membrodabancaii{}
\membrodabancaiifuncao{}
\membrodabancaiii{Calos Humberto Llanos Quintero}
\membrodabancaiiifuncao{}
\membrodabancaiv{Sadek Crisostomo Absi Alfaro}
...
\dedicatoriaautori{Dedico este trabalho a...}
