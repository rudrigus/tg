...
I = imread(ImagemBase);
tamanho = size(I);
[ImagemTratada,posArameTopo,posArameBase,limEsqPoca,limDirPoca,ladoEsqArame,ladoDirArame,pixelsArameBase] = processamentoRelatorio(I,tamanho,1,181);
...
%   I2=I;
  ...
  [I2,posArameTopo(j-inicio+1),posArameBase(j-inicio+1),limEsqPoca(j-inicio+1),limDirPoca(j-inicio+1),ladoEsqArame,ladoDirArame,pixelsArameBase(j-inicio+1)] = processamentoRelatorio(I2,tamanho2,1,j);
...
p1=plot(diametroArame * limEsqPoca ./ pixelsArameBase);
p2=plot(diametroArame * limDirPoca ./ pixelsArameBase);
...
p5=plot(CentroArameTopo);
p6=plot(CentroArameBase);
